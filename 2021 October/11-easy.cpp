// Author: envy
// Problem: A. Save Luke from Codeforces - AIM Tech Round (Div. 2)
// URL: https://codeforces.com/problemset/problem/624/A
// Limits: 1000 ms, 256 MB
// Attempted: 2021-10-11 13:18:04 EST
...
void doStuff(){
	int d, length, v1, v2; cin>>d>>length>>v1>>v2;
	double center = length * (v1 * 1.0 / (v1+v2));
	center += d * (v2 * 1.0 / (v1+v2));
	cout<<fixed<<(length - center) / v2<<endl;
