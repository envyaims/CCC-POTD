// Author: envy
// Problem: A. Boring Apartments from Codeforces - Codeforces Round #677 (Div. 3)
// URL: https://codeforces.com/problemset/problem/1433/A
// Limits: 1000 ms, 256 MB
// Attempted: 2021-09-29 19:41:42 EST
...
void doStuff(){
	int n; ri(n);
	print((n % 10 - 1)*10 + (to_string(n).length() * (to_string(n).length() + 1))/2);
