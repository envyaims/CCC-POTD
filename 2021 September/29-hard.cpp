// Author: envy
// Problem: E. Two Round Dances from Codeforces - Codeforces Round #677 (Div. 3)
// URL: https://codeforces.com/problemset/problem/1433/E#
// Limits: 1000 ms, 256 MB
// Attempted: 2021-09-29 19:16:26 EST
...
void doStuff(){
	...
	int n; ri(n);
	print(ncr(n,n/2) * factorial[n/2-1] * factorial[n/2-1] / 2);
