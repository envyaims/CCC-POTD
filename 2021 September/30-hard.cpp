// Author: envy
// Problem: D. Count the Arrays from Codeforces - Educational Codeforces Round 83 (Rated for Div. 2)
// URL: https://codeforces.com/problemset/problem/1312/D
// Limits: 2000 ms, 512 MB
// Attempted: 2021-09-30 21:45:30 EST
...
typedef long long ll; const ll INF = 1e18; const int MOD = 998244353;
...
void doStuff(){
    ...
    print(ncr(m,n-1)*(n-2) % MOD *pow(2,max(0LL,n-3),MOD) % MOD);
}
